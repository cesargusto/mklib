...
public class Extenso {
     ...
     */
    public Extenso(BigDecimal dec, boolean moeda) {
        this(moeda);
        setNumber(dec);
    }

    public Extenso(Integer integer, boolean moeda) {
        this(moeda);
        setNumber(new BigDecimal(integer));
    }
     ...
     *@param  dec  valor para colocar por extenso
     */
    public Extenso(double dec, boolean moeda) {
        this(moeda);
        setNumber(dec);
    }
