		...
		try {
			if (modalidade == null) {
				...
				buttonPesquisar.grabFocus();
					...
					InputStream streamResource = JanelaRelatorioClientePorModalidade.class.getClassLoader().getResourceAsStream("resource/report/RelatorioClientePorModalidade.jasper");
